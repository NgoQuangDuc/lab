...
void encrypt(ll e_val,string filename) {
    ...
    // Đọc từng dòng từ file và lưu vào c1, c2, c3
    int len = 0; // Gán giá trị len mặc định
...
void decrypt_new(string filename) {
    ll num[] = {m1, m2, m3};
    ...
    for (ll i = 0; i < len100; i++) {
        ...
        outfile << char(fin_msg[i]); // Ghi vào file
    }
    outfile << endl; // Ghi xuống dòng sau khi hoàn tất
...
string filename;
    ...
    cout<<"Enter N1,N2,N3 values"<<endl;
